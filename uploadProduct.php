        ...
        if ($image !== null && $image["error"] == UPLOAD_ERR_OK) {
            ...
            if (move_uploaded_file($image["tmp_name"], $target_file)) {
                ...
                if ($conn->query($sql) === true) {
                    ...
                    $query = "SELECT ProductID FROM Products WHERE ProductName = '$product_name' AND Price = '$price' AND Brand = '$brand' AND image_path = '$image_path';";
                    ...
                    $query = "INSERT INTO sellerProducts(SellerID, ProductID) VALUES ('$SellerID','$productID')";
                    ...
                    $message = "Error inserting into Products: " . $conn->error;
                    $popupClass = "error-popup";
                }
            } else {
            ...
            $message = "Error: Invalid image for Product";
            $popupClass = "error-popup";
        }
    }
                    ...
                    <div class="form-container-inner">
                        <form action="" method="post" enctype="multipart/form-data" class="myform">
                            <div class="inputs">
                                ...
                                <input type="text" name="product_name" required class="myform-input" autocomplete="on" autofocus>
                            </div>
